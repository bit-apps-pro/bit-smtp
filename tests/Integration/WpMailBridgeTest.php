...
final class WpMailBridgeTest extends IntegrationTestCase
{
    ...
    public function test_wp_mail_delivers_to_mailpit_and_marks_send_successful(): void
    {
    ...
    public function test_reset_for_send_clears_debug_output_between_consecutive_sends(): void
    {
